...
import LoginSociall from "../../components/Shared/LoginSociall";
		...
		<div>
			<div className=" min-h-screen bg-[#f5f1eb] pb-24 md:py-14 flex-wrap">
				<div className="flex justify-center items-center">
					...
					<div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-[#edf3f3] border shadow-lg text-gray-900">
